...
--
-- Host: 127.0.0.1
-- Generation Time: May 14, 2019 at 12:36 AM
...
--
ALTER TABLE `t_document_track`
  MODIFY `docu_tr_ID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `t_document_track_history`
--
ALTER TABLE `t_document_track_history`
  MODIFY `docu_tr_his_ID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `t_users_log`
  MODIFY `log_No` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=61;
