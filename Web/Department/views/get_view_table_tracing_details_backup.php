   ...
   <?php
           ...
           while($row1 = mysqli_fetch_array($view_query1))
           {
               ...
               //For Closer
                ...
                echo      '</td>';
                echo      '<td width="" style="font-style:italic"> ';
                            if($docu_action == 'Created')
                            {
                              echo  'Ticket '.$docu_action.' by '.$creator_compname.', issued by the '.$created_office_name.'.';
                            }
                            else if($docu_action == 'Reviewed and Transferred')
                            {
                              echo  'Ticket '.$docu_action.' to '.$receiver_office_name.' by '.$sender_compname.'.';
                            }
                            else if($docu_action == 'Received')
                            {
                              echo  'Ticket '.$docu_action.' by '.$receive_compname.', from the '.$receiver_office_name.'.';
                            }
                            else if($docu_action == 'Closed')
                            {
                              echo  'Ticket '.$docu_action.' by '.$closer_compname.', from the '.$closer_office_name.'.';
                            }
                            else if($docu_action == 'Re-Opened')
                            {
                              echo  'Ticket '.$docu_action.' by '.$reopen_compname.', from the '.$reopen_office_name.'.';
                            }
                echo      '</td>';
                echo      '<td width=""> ';
                            if($docu_action == 'Created')
                            {
                              echo  $docu_tr_remarks;
                            }
                            else if($docu_action == 'Reviewed and Transferred')
                            {
                              echo  $docu_tr_remarks;
